...
if __name__ == '__main__':
    with tf.Session() as sess:
        ...
        for it in range(ITERATIONS):
            sess.run(train_step)
            if ( ((it <= 100)Ω) or (it <= 200 and it%2 == 0) or (it <= 300 and it%4 == 0) or (it <= 400 and it%8 == 0)or it%16 == 0):
